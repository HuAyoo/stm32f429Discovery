...
#define  BSP_GPIOG_LED1                        DEF_BIT_00
#define  BSP_GPIOG_LED2                        DEF_BIT_01
...
static void  BSP_LED_Init()
{
    ...
    BSP_PeriphEn(BSP_PERIPH_ID_GPIOB);                          /* Configure GPIOB for LED1绿色 and LED2 红色                   */
...
void  BSP_LED_On (CPU_INT08U  led)
{
    switch (led) {
        case 0u:
             HAL_GPIO_WritePin(GPIOB, (BSP_GPIOG_LED1 | BSP_GPIOG_LED2), GPIO_PIN_RESET);
             break;


        case 1u:
             HAL_GPIO_WritePin(GPIOB, BSP_GPIOG_LED1, GPIO_PIN_RESET);//绿色
             break;


        case 2u:
             HAL_GPIO_WritePin(GPIOB, BSP_GPIOG_LED2, GPIO_PIN_RESET);//红色
             break;
...
void  BSP_LED_Toggle (CPU_INT08U  led)
{
    switch (led) {
        case 0u:
             HAL_GPIO_TogglePin(GPIOB,(BSP_GPIOG_LED1 | BSP_GPIOG_LED2));
             break;


        case 1u:
             HAL_GPIO_TogglePin(GPIOB,BSP_GPIOG_LED1);
             break;
